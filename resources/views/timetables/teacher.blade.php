...
<body>
    <div class="header">
        ...
        @endif
        <div class="document-title">Teacher Timetable</div>
    </div>

    <div class="teacher-info">
        <div class="teacher-info-grid">
            <div class="teacher-info-row">
                <div class="teacher-info-label">Teacher Name:</div>
            ...
            @if($teacher->phone)
            <div class="teacher-info-row">
                <div class="teacher-info-label">Phone:</div>
                <div class="teacher-info-value">{{ $teacher->phone }}</div>
            </div>
            @endif
            @if($teacher->qualification)
            <div class="teacher-info-row">
                <div class="teacher-info-label">Qualification:</div>
                <div class="teacher-info-value">{{ $teacher->qualification }}</div>
            </div>
            @endif
            @if($teacher->specialization)
            <div class="teacher-info-row">
                <div class="teacher-info-label">Specialization:</div>
                <div class="teacher-info-value">{{ $teacher->specialization }}</div>
            </div>
            @endif
        </div>
    </div>
    ...
    <div class="stats-container">
        ...
        <div class="stat-box">
            ...
            <span class="stat-label">Subjects Teaching</span>
        </div>
        <div class="stat-box">
            <span class="stat-value">{{ $classesCount }}</span>
                            ...
                            <td>
                                @if(isset($scheduleGrid[$day][$period->id]) && $scheduleGrid[$day][$period->id])
                                    ...
                                    <div class="timetable-entry">
                                        ...
                                        <div class="entry-class">{{ $entry->class->name }} - {{ $entry->section->name }}</div>
